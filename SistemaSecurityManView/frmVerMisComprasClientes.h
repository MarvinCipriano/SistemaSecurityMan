...
namespace SistemaSecurityManView {
	...
	/// <summary>
	/// Resumen de frmVerMisComprasClientes
	/// </summary>
	public ref class frmVerMisComprasClientes : public System::Windows::Forms::Form
	{
	public:
		frmVerMisComprasClientes(void)
		{
			InitializeComponent();
			//
		...
		frmVerMisComprasClientes(Clientes^ objClientes)
		{
			InitializeComponent();
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button2->Click += gcnew System::EventHandler(this, &frmVerMisComprasClientes::button2_Click);
			// 
			// groupBox1
			// 
			...
			this->Name = L"frmVerMisComprasClientes";
			this->Text = L"frmVerMisComprasClientes";
			this->Load += gcnew System::EventHandler(this, &frmVerMisComprasClientes::frmVerMisComprasClientes_Load);
...
#pragma endregion
	...
	private: System::Void frmVerMisComprasClientes_Load(System::Object^ sender, System::EventArgs^ e) {
		//VENTANA
