...
namespace SistemaSecurityManView {
	...
	/// <summary>
	/// Resumen de frmNuevoComponente
	/// </summary>
	public ref class frmNuevoComponente : public System::Windows::Forms::Form
	{
	public:
		frmNuevoComponente(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->Cancelar->Click += gcnew System::EventHandler(this, &frmNuevoComponente::Cancelar_Click);
			// 
			// Grabar
			// 
			...
			this->Grabar->Click += gcnew System::EventHandler(this, &frmNuevoComponente::Grabar_Click);
			// 
			// groupBox1
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &frmNuevoComponente::button1_Click);
			// 
			// label1
			// 
			...
			this->Name = L"frmNuevoComponente";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterParent;
			this->Text = L"Nuevo Componente";
...
#pragma endregion
	...
	private: System::Void Grabar_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		String^ Utilidad = this->textBox2->Text;
		ComponentesController^ objComponentesController = gcnew ComponentesController();
		int existe = objComponentesController->ExisteComponentesNombre(Nombre);
		if (existe) {
			MessageBox::Show("Ya existe un componente registrado en el sistema con el nombre de " + Nombre);
		}
		else {
			Componentes^ objComponentes = gcnew Componentes();
			objComponentes->setNombre(Nombre);
			objComponentes->setUtilidad(Utilidad);
			objComponentes->setStock(0);
			if (NombreImagen == "") {
				objComponentes->setImagen("");
			}
			else{
				objComponentes->setImagen(NombreImagen);
			}
			objComponentesController->AregarComponente(objComponentes);
			MessageBox::Show("El nuevo componente ha sido registrado con exito");
			this->Close();
		}
	}
