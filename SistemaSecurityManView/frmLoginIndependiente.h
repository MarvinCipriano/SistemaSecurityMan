...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->Iniciar_Sesión->Text = L"Independiente";
			this->Iniciar_Sesión->Enter += gcnew System::EventHandler(this, &frmLoginIndependiente::Iniciar_Sesión_Enter);
			// 
			// button3
			// 
...
private: System::Void Iniciar_Sesión_Enter(System::Object^ sender, System::EventArgs^ e) {
}
};
}
