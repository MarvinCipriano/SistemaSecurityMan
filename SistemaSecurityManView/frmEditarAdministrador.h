...
namespace SistemaSecurityManView {
	...
	/// <summary>
	/// Resumen de frmEditarAdministrador
	/// </summary>
	public ref class frmEditarAdministrador : public System::Windows::Forms::Form
	{
	public:
		frmEditarAdministrador(void)
		{
			InitializeComponent();
			//
		...
		frmEditarAdministrador(Administrador^ objAdmin)
		{
			InitializeComponent();
			this->objAdminLocal = objAdmin;
			//
			//TODO: agregar código de constructor aquí
			//
		}
	...
	//
	private: Administrador^ objAdminLocal;
	//
	private:
		/// <summary>
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->Cancelar->Click += gcnew System::EventHandler(this, &frmEditarAdministrador::Cancelar_Click);
			// 
			// Grabar
			// 
			...
			this->Grabar->Click += gcnew System::EventHandler(this, &frmEditarAdministrador::Grabar_Click);
			// 
			// groupBox1
			// 
			...
			this->groupBox1->Text = L"Editar Administrador";
			// 
			// textdni
			// 
			...
			this->Name = L"frmEditarAdministrador";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterParent;
			this->Text = L"Editar Administrador";
			this->Load += gcnew System::EventHandler(this, &frmEditarAdministrador::frmEditarAdministrador_Load);
...
#pragma endregion
	private: System::Void Grabar_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		int existe1 = objAdminController->ExisteAdminEmailconDNI(Email, DNI);
		...
		if (existe1 || existe2) {
			...
			objClientesController->ActualizarClientes(DNI, Email, Contrasenha);
			objAdminController->ActualizarAdmin(Nombre, Apellido, DNI, Email, Contrasenha, Telefono);
	...
	private: System::Void frmEditarAdministrador_Load(System::Object^ sender, System::EventArgs^ e) {
		//VENTANA
		this->textnombre->Text = this->objAdminLocal->getNombre();
		this->textapellido->Text = this->objAdminLocal->getApellido();
		this->textdni->Text = Convert::ToString(this->objAdminLocal->getDNI());
		this->textemail->Text = this->objAdminLocal->getEmail();
		this->textcontra->Text = this->objAdminLocal->getContrasenha();
		this->texttelefono->Text = this->objAdminLocal->getTelefono();
	}
};
}
