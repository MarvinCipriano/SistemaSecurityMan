...
namespace SistemaSecurityManView {
	...
	/// <summary>
	/// Resumen de frmVerMisCompras
	/// </summary>
	public ref class frmVerMisCompras : public System::Windows::Forms::Form
	{
	public:
		frmVerMisCompras(void)
		{
			InitializeComponent();
			//
		...
		frmVerMisCompras(Clientes^ objClientes)
		{
			InitializeComponent();
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button2->Click += gcnew System::EventHandler(this, &frmVerMisCompras::button2_Click);
			// 
			// dataGridView1
			// 
			...
			this->dataGridView1->Size = System::Drawing::Size(873, 409);
			...
			this->groupBox1->Size = System::Drawing::Size(879, 434);
			...
			this->ClientSize = System::Drawing::Size(903, 490);
			this->Controls->Add(this->button2);
			this->Controls->Add(this->groupBox1);
			this->Name = L"frmVerMisCompras";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterParent;
			this->Text = L"frmVerMisCompras";
			this->Load += gcnew System::EventHandler(this, &frmVerMisCompras::frmVerMisCompras_Load);
...
#pragma endregion
	...
	private: System::Void frmVerMisCompras_Load(System::Object^ sender, System::EventArgs^ e) {
		//VENTANA
		FacturaModelController^ objFacturaModelController = gcnew FacturaModelController();
		List<FacturaModel^>^ listafactura = objFacturaModelController->BuscarListaFacturaxID(objClienteslocal->getIdentificacion());
