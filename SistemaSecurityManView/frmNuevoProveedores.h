...
namespace SistemaSecurityManView {
	...
	/// <summary>
	/// Resumen de frmNuevoProveedores
	/// </summary>
	public ref class frmNuevoProveedores : public System::Windows::Forms::Form
	{
	public:
		frmNuevoProveedores(void)
		{
			InitializeComponent();
			//
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->Cancelar->Click += gcnew System::EventHandler(this, &frmNuevoProveedores::Cancelar_Click);
			// 
			// Grabar
			// 
			...
			this->Grabar->Click += gcnew System::EventHandler(this, &frmNuevoProveedores::Grabar_Click);
			// 
			// groupBox1
			// 
			...
			this->groupBox1->Text = L"Agregar Proveedor";
			// 
			// textruc
			// 
			...
			this->Name = L"frmNuevoProveedores";
			this->StartPosition = System::Windows::Forms::FormStartPosition::CenterParent;
			this->Text = L"Nuevo Proveedor";
			this->Load += gcnew System::EventHandler(this, &frmNuevoProveedores::frmNuevoProveedores_Load);
...
#pragma endregion
	...
	private: System::Void Grabar_Click(System::Object^ sender, System::EventArgs^ e) {
		...
		int existe1 = objProveedoresController->ExisteProveedoresxRUC(RUC);
		int existe2 = objProveedoresController->ExisteProveedoresxEmail(Email);
		int existe3 = objProveedoresController->ExisteProveedoresxNombre(Nombre);
		int existe4 = objProveedoresController->ExisteProveedoresxTelefono(Telefono);
		...
		else if (existe1 == 0 && existe2 == 0 && existe3 == 0 && existe4 == 0) {
			objProveedoresController->RegistrarProveedores(Nombre, RUC, Email, Direccion, Convert::ToInt32(Telefono));
			MessageBox::Show("El nuevo proveedor ha sido registrado con exito");
			this->Close();
		}
	}
	private: System::Void frmNuevoProveedores_Load(System::Object^ sender, System::EventArgs^ e) {
		//VENTANA
	}
};
}
